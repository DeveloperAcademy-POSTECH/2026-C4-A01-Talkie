...
struct SafetyContactDetailView: View {
    ...
    @FocusState private var focusedField: SafetyContactDetailField?
            ...
            DarkScreen {
                ZStack(alignment: .bottom) {
                    ...
                    VStack(alignment: .leading, spacing: 0) {
                        ...
                        .padding(.top, 24)
                        .padding(.bottom, contact == nil ? 32 : 120)
...
private extension SafetyContactDetailView {
    ...
    func contactTextField(
        ...
        focusField: SafetyContactDetailField
    ) -> some View {
        TextField(
            "",
            text: text,
...
private enum SafetyContactDetailField: Hashable {
    case name
    case phoneNumber
}
